<%@ Page Title="" Language="C#" MasterPageFile="~/mstInner.Master" AutoEventWireup="true" CodeBehind="ReleaseComments.aspx.cs" Inherits="PreOrderWorkflow.Release_comments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div style="text-align:center;font-size:16px;font-weight:bold">Release Comments</div>
      <div class="container">
        ...
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" Width="95%" CssClass="table table-bordered table-hover" HeaderStyle-BackColor="#e9e9e9">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Action">
                    <ItemTemplate>
                        <asp:Button  CssClass="btn-link" runat="server" ID="btnReleseComment" OnClick="btnReleseComment_Click" CommandArgument='<%#Eval("WFID")+"&"+ Eval("Parent_WFID") %>' Text="Edit"/>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
